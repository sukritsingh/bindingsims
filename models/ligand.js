...
// core model descriptor: ligand

import { calculate_ligand_free, calculate_ligand_total } from '../core/solvers.js';
...
export const ligand = {
	...
	fitSolve(m, x, xscale_alternative) {
		return xscale_alternative
			? calculate_ligand_free(m[5], x, m[7])
			: calculate_ligand_total(m[5], x, m[7]);
	},
};
